/*
  ...
  1. New Tables
    - `favorite_friends` - Store favorite friend relationships
    - `friend_notes` - Store personal notes about friends
    - `friend_tags` - Store friend tag definitions
    - `friend_tag_assignments` - Assign tags to friends

  2. New Functions
    - `get_mutual_friends` - Get mutual friends between users
    - `get_mutual_friends_count` - Count mutual friends between users
